module github.com/nebula-aac/kubernexus-mono/pkg/nexus-adapters
...
require (
	...
	github.com/nebula-aac/kubernexus-mono/pkg/nexuslogger v0.0.0-00010101000000-000000000000
)
